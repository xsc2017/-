...
<iframe src="../editor/upload.asp?sortType=14&stype=file&amp;Tobj=ImagePathr" scrolling="no" topmargin="0" height="40" width="100%" marginwidth="0" marginheight="0" frameborder="0" align="left"></iframe></TD>
  ...
  <TR>
    ...
    <TD><input maxlength="20"  name="stime" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="<%=formatDate(now(),4)%>"/> <img src="../images/help.gif" class="tTip" title="广告有效期，广告出现的开始时间和结束时间，超过该时间广告不显示"></TD>
  </TR>
  <TR>
