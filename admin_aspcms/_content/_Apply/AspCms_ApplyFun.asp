...
Sub editApply
	...
	conn.exec "update {prefix}Apply set Linkman='"&Linkman&"',Gender="&Gender&",Age="&Age&",Marriage='"&Marriage&"',RegResidence='"&RegResidence&"',JobResume='"&JobResume&"',Education='"&Education&"',EduResume='"&EduResume&"',Address='"&Address&"',PostCode='"&PostCode&"',phone='"&phone&"',Mobile='"&Mobile&"',Email='"&Email&"',QQ='"&QQ&"',ApplyStatus="&ApplyStatus&"  where ApplyID="&ApplyID,"exe"
