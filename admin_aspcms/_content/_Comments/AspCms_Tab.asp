...
<TABLE height=30 cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    <INPUT onClick="location.href='AspCms_TabAdd.asp'" type="button" value="添加参数" class="button" >
...
<DIV class=piliang>
<INPUT onClick="checkAll(this,'id'),checkAll(this,'TabField')" type="checkbox" value="1" name="SELALL"> 全选&nbsp;
