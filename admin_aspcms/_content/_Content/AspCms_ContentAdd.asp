...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
 ...
 <%	if sortType="2" then%>
  <TR>
    ...
    <TD width="231"><input class="input" maxlength="200" value="" style="WIDTH: 160px" name="Author"/></TD>
    <TD width="78">来源 </TD>
    <TD width="395"><input class="input" maxlength="200"  value="" style="WIDTH: 160px" name="ContentSource" /></TD>
  </TR>
  <%end if%>
  <TR>
