		...
		for i = 1 to numPerPage	
			if i mod 2=1 then
			 echo "<tr bgcolor=""#ffffff"" align=""center"" onMouseOver=""this.bgColor='#CDE6FF'"" onMouseOut=""this.bgColor='#FFFFFF'"">"
			  ...
			  echo "<tr bgcolor=""#eeeeee"" align=""center"" onMouseOver=""this.bgColor='#CDE6FF'"" onMouseOut=""this.bgColor='#eeeeee'"">"
			 end if
				...
				echo "<td>"&getStr(rsObj("pay"),"<a href=""?action=pay&orderno="&rsObj(0)&"&s=0"" title=""已付款"" ><IMG src=""../../images/toolbar_ok.gif""></a>","<a href=""?action=pay&orderno="&rsObj(0)&"&s=1"" title=""未付款"" ><IMG src=""../../images/toolbar_no.gif""></a>")&"</td>"
				...
				echo "<td>"&getStr(rsObj("print"),"<a href=""?action=print&orderno="&rsObj(0)&"&s=0"" title=""已打印"" ><IMG src=""../../images/toolbar_ok.gif""></a>","<a href=""?action=print&orderno="&rsObj(0)&"&s=1"" title=""未打印"" ><IMG src=""../../images/toolbar_no.gif""></a>")&"</td>"
