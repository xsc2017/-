...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  ...
  <TR>						
    <TD align=middle width=100 height=30>分类英文名称</TD>
    <TD><INPUT class="input" style="WIDTH: 200px" maxLength="200" name="SortEnName" value=""/> <FONT color=#ff0000>*</FONT> </TD>
  </TR>
  <% end if %>
  <TR>
...
switch(t)
   ...
   case "1":
     ...
     document.getElementById("SortFileName").value="{sortid}";
   ...
   case "2":
     ...
     document.getElementById("SortFileName").value="{sortid}-{page}";
     document.getElementById("ContentFileName").value="{id}";    
  ...
  <TR id="hid1">
    ...
    <TD> <%tempList "SortTemplate","newslist.html" %>   <img src="../../images/help.gif" class="tTip" title="该分类使用的列表的模板的文件名"></TD>
  </TR>
  <TR id="hid2">
    <TD align=middle height=30>内容页模板</TD>
    <TD> <%tempList "ContentTemplate","news.html" %>  <img src="../../images/help.gif" class="tTip" title="该分类的内容详细页使用的模板的文件名">    </TD>
  </TR>
  <TR id="hid3">
  ...
  <TR id="hid5">
    ...
    <TD> <input class="input" maxlength="200" style="WIDTH: 200px" name="SortFileName" id="SortFileName" value="{sortid}-{page}"/>
...
"> </TD>
  ...
  <TR  id="hid6">
    ...
    <TD> <input class="input" maxlength="200" style="WIDTH: 200px" name="ContentFileName" id="ContentFileName" value="{id}"/>
...
专属为只有设定的该组可以访问"></TD>
  ...
  <TR id="hid8">
    ...
    内容<BR><BR>
       <a href="javascript:void()" onClick="SetEditorPage('Content', '{aspcms:page}')"> 插入分页<BR>
       {aspcms:page}</a></TD>
...
<script type="text/javascript">
    ...
    <tr>
    <TD align=middle height=30 valign="top">栏目图片</td>
      <td colspan="3"><input class="input" maxlength="255" style="WIDTH: 400px" id="IcoImage" name="IcoImage" /> <img src="../../images/help.gif" class="tTip" title="栏目图片，可在前台调用"><iframe name="image" frameborder="0" width='100%' height="40" scrolling="no" src="../../editor/upload.asp?sortType=3&stype=file&Tobj=IcoImage" allowTransparency="true"></iframe></td>
    </tr>
    	<tr>
    <TD align=middle height=30 valign="top">文章缩略图</td>
