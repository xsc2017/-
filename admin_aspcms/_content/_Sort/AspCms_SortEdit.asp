...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  ...
  <TR>						
    ...
    <TD><INPUT class="input" style="WIDTH: 200px" maxLength="200" name="SortEnName" value="<%=SortEnName%>"/> <FONT color=#ff0000>*</FONT> </TD>
  </TR>
  <% end if %>
  <TR<% if not isnul(usertype) then %> class="hid"<%end if%>>
...
<script type="text/javascript">
    ...
    <TD align=middle height=30 valign="top">栏目图片</td>
      <td colspan="3"><input class="input" maxlength="255" style="WIDTH: 400px" id="IcoImage" name="IcoImage" value="<%=IcoImage%>"/><iframe name="image" frameborder="0" width='100%' height="40" scrolling="no" src="../../editor/upload.asp?sortType=3&stype=file&Tobj=IcoImage" allowTransparency="true"></iframe></td>
    </tr>
    	<tr>
