...
<BODY>
<FORM action="?action=add" method="post" name="frmSpec">
...
<TD><INPUT class="input" style="WIDTH: 200px" onKeyUp="document.getElementById('endShow').innerHTML=value" maxLength="200" name="SpecField"  value="<%=SpecField%>"/> <FONT color=#ff0000>*预览 [<span id="preShow"></span><span id="spShow"></span><span id="endShow"></span>]</FONT></TD>
</tr>
<TR>
