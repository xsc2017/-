...
<TBODY>
	...
	<TR>
        <TD align=middle height=30>链接分组</TD>
        <TD>
		<input name="Linkgroup" type="radio" value="1" <%if Linkgroup=1 then%>  checked="checked"<%end if%>>1<input name="Linkgroup" type="radio" value="2"<%if Linkgroup=2 then%>  checked="checked"<%end if%>>2<input name="Linkgroup" type="radio" value="3"<%if Linkgroup=3 then%>  checked="checked"<%end if%>>3
        </TD>
    </TR>
    <TR>
