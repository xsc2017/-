...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  ...
  <TR>						
    ...
    <TD>
        <input type="radio"  value="1" name="serviceStyle" <% if serviceStyle=1 then echo "checked" end if%>/><img src="../../images/qqstyle1.jpg" height="100">
        <input type="radio"  value="2" name="serviceStyle" <% if serviceStyle=2 then echo "checked" end if%>/><img src="../../images/qqstyle2.jpg" height="100">
        <input type="radio"  value="3" name="serviceStyle" <% if serviceStyle=3 then echo "checked" end if%>/><img src="../../images/qqstyle3.jpg" height="100">
  </TR>
  <TR>						
  ...
  <TR>						
    <TD align=middle width=193 height=60 valign="top">微信账号</TD>
    <TD style="line-height:1.5em;">
    <input class="input" maxlength="255" style="WIDTH: 400px" id="serviceWeiXin"  name="serviceWeiXin" value="<%=serviceWeiXin%>"/> (若需要请上传微信二维码图片)
    <iframe name="image" frameborder="0" width='100%' height="40" scrolling="no" src="../../editor/upload.asp?sortType=16&stype=weixin&Tobj=serviceWeiXin" allowTransparency="true"></iframe>

    </TD>
  </TR>
  
  <TR>						
    <TD align=middle width=193 height=30>新浪微博</TD>
    
    <TD style="line-height:1.5em;">
     <input class="input" maxlength="255" style="WIDTH: 400px" id="serviceWeibo"  name="serviceWeibo" value="<%=serviceWeibo%>"/> (请输入新浪微博账号UID)
    </TD>
  </TR>
