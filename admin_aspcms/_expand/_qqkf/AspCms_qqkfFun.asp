...
Sub saveService
	...
	configStr=templateobj.regExpReplace(configStr,"Const serviceWeiXin=""(\S*?\s?)*""","Const serviceWeiXin="""&getForm("serviceWeiXin","post")&"""")

	configStr=templateobj.regExpReplace(configStr,"Const serviceWeiBo=""(\S*?\s?)*""","Const serviceWeiBo="""&getForm("serviceWeiBo","post")&"""")
