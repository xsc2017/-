...
Sub saveService
	...
	configStr=templateobj.regExpReplace(configStr,"Const slidestyle=(\d?)","Const slidestyle="&getForm("slidestyle","post")&"")
...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  ...
  <TR>
    ...
    <TD><input type="radio"  value="0" name="slidestyle" <% if slidestyle=0 then echo "checked" end if%>/>默认
            <input type="radio" value="1" name="slidestyle" <% if slidestyle=1 then echo "checked" end if%>/><img src="../../images/slide1.jpg" width="150"></TD>
  </TR>
  <TR>
    <TD align=middle width=100 height=30>幻灯片调用标签</TD>
    <TD>{aspcms:slide} 或 {aspcms:slidea}</TD></TR>
  <TR>
    </TBODY></TABLE>
</DIV>
