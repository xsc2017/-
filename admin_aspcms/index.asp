...
<%
if isnul(session("adminName")) or Session("sitepath")<>SitePath then response.Redirect("login.asp"):response.End()
...
<title><%=setting.siteTitle%>-网站内容管理系统- Powered by <%=aspcmsVersion%> </title>
	...
	<frameset rows="63,*" cols="*" frameborder="no" border="0" framespacing="0">
		...
		<frameset cols="176,*" name="bodyFrame" id="bodyFrame" frameborder="no" border="0" framespacing="0"  >
			<frame src="menu.asp?id=1&src=right.asp" name="menu" id="menu" scrolling="auto" noresize />
			<frame src="right.asp" name="main" id="main" scrolling="auto" noresize />
