...
if action = "login" then
	...
	if rsObj(0)=1 then
		...
		if not rsObj.Eof Then
			...
			Conn.Exec"update {prefix}User set LastLoginTime='"&formatDate(now(),4)&"',LastLoginIP='"&getIp()&"',LoginCount=LoginCount+1 where UserID="&rsObj("UserID"),"exe"	
			if atype=0 then		
...
<title><%=setting.siteTitle%>-开源企业网站管理系统- Powered by <%=aspcmsVersion%></title>
<style type="text/css">
<!--
*{
	padding:0px;
...
<body>
	...
	<div class="main">
		...
		<form method="post" action="?action=login" onsubmit="writeCookie('username',this.username.value, 1)">
            ...
            <div class="inputbox">
                ...
                <dl>
					<dt>类型：</dt>
					<dd><input name="atype" type="radio" value="1" />简单版  <input name="atype" type="radio" value="0" checked="checked" />全功能版
					</dd>
				</dl>
            ...
            <dl>
					<dt></dt>
			  <dd>
                    <span style="color:#505050;font-size:12px;display:block">ASPCMS!是 <a href="http://www.asp4cms.com"  target="_blank" style="color:#315D80">上谷网络</a> 旗下 <a href="http://www.asp4cms.com" target="_blank" style="color:#315D80">开源创新实验室</a> 推出的以企业建站为基础的专业建站系统，帮助其实现一站式服务。</span>
                   
               <a href="/">返回首页</a><!-- | <a href="http://www.asp4cms.com">上谷网络</a> | <a href="http://www.asp4cms.com">开源创新实验室</a>			   --></dd>
			  </dl>
			</div>
		</form>
	...
	<div class="copyright">
		Powered by <a href="http://www.asp4cms.com">www.asp4cms.com</a> Copyright &copy;2010-2015 
	</div>
