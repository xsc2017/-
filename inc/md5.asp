...
Private Function ConvertToWordArray2(sMessage)
    Dim lMessageLength
    Dim lNumberOfWords
    Dim lWordArray()
    Dim lBytePosition
...
Public Function MD5(sMessage,stype)
	...
	If LCase(stype) = "utf-8" Then 
        x = ConvertToWordArray(str2bin_utf(sMessage))
	ElseIf LCase(stype) = "gb2312" Then
        x = ConvertToWordArray(str2bin(sMessage))
	else
		x = ConvertToWordArray2(sMessage)
	End If
	...
	if stype="32" or LCase(stype)="utf-8" or LCase(stype)="gb2312"  then
