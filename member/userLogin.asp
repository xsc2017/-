...
document.write("              <input type=\"button\" value=\"注册\" onclick=\"location.href=\'<%=sitepath%>/member/reg.asp\'\" style=\"BORDER: #CCCCCC 1px solid;WIDTH: 60px; height:22px;cursor:pointer\"/></td>");
