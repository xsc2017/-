...
dim payment_type,out_trade_no,total_fee
        ...
        '必填，不能修改
        '服务器异步通知页面路径
        'notify_url = "http://demo.asp4cms.com"&sitepath&"/order/alipay/notify_url.asp"
        '需http://格式的完整路径，不能加?id=123这类自定义参数

        '页面跳转同步通知页面路径
        'return_url = "http://demo.asp4cms.com"&sitepath&"/order/alipay/return_url.asp"
        ...
        '订单名称
        'subject ="【网站订单】aspcms网站订单" 'Request.Form("WIDsubject")
        '必填
