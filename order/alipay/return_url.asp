...
If sVerifyResult Then	'验证成功
	...
	'商户订单号
	out_trade_no = filterPara(Request.QueryString("out_trade_no"))

	'支付宝交易号
	trade_no = filterPara(Request.QueryString("trade_no"))

	'交易状态
	trade_status = filterPara(Request.QueryString("trade_status"))
