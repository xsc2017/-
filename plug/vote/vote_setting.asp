...
<TBODY>
    ...
    <TR class=list>
      <TD>投票标题设置</TD>
      <TD><INPUT class="input" size="30" style="width:80%" value="<%=votetitle%>" id="votetitle" name="votetitle"/></TD>
    </TR>
    <TR class=list>
        <TD>投票选项设置（请用|隔开,例如 a|b|c|d）</TD>
        <TD width=507><INPUT class="input" size="30" style="width:80%" value="<%=votename%>" id="votename" name="votename"/></TD>
    </TR>
   
    <TR class=list>
        <TD>投票票数设置（请与选项数量一致，按以上例子为 0|2|3|4）</TD>
        <TD width=507><INPUT class="input" size="30" style="width:80%" value="<%=votenum%>" id="votenum" name="votenum"/></TD>
    </TR>
