...
dim sql
	...
	sql = "INSERT INTO {prefix}order2 ( orderno, username, ordertime, state, payment, nicename, tel, cellphone, zipcode, address, email, [note], [to], invoice,userid)VALUES ('"&orderno&"', '"&username&"', '"&formatDate(now(),4)&"', "&m_state&", '"&payment&"', '"&nicename&"', '"&tel&"', '"&cellphone&"', '"&zipcode&"', '"&address&"', '"&email&"', '"&note&"', '"&m_to&"', "&invoice&", "&userid&")"
