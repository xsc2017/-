...
result = result & "<div style='float:left;width:600px'><a class='button_2' style='float:left;letter-spacing:0px; margin-right:20px;' href='../list/?107_1.html'>继续购物</a> <a class='button_2' style='float:left' href='checkout.asp'>订购</a></div>"
result = result & "</form>"
